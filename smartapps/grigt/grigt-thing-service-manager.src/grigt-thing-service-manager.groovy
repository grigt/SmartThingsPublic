 ...
 */
definition(
		name: "grigt Thing Service Manager",
		namespace: "grigt",
		author: "grigt",
		description: "This is a basic UPnP Service Manager SmartApp",
...
preferences {
	page(name: "searchTargetSelection", title: "UPnP Search Target", nextPage: "deviceDiscovery") {
		section("Search Target") {
			input "searchTarget", "string", title: "Search Target", defaultValue: "urn:schemas-upnp-org:device:grigt:1", required: true
		}
	}
